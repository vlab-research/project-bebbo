...
for (dataset in names(datasets)) {
    ...
    rename(`Treated` = treated, `Used App` = has_learned, `Used App Ratio` = has_learned_perc, `Used App More Than One Day` = learned_more_than_one_day, `Used App More Than One Day Ratio` = more_than_one_day_perc)
