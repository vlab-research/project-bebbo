...
\addcontentsline{toc}{section}{Descriptives}
...
% \addcontentsline{toc}{subsection}{Construct variables descriptives}
% \subsection*{Construct variables}

% \subsubsection*{Likert Variables}

% Likert variables are coded as ordinal from 1 to 4 with 4 being closest to the desired target response and 1 being furthest from it. For example, for a question about attitudes of parents towards physical punishment, a desired response would be "Strongly disagree" which would be a coded as a 4. For a question about how often a parent feels the stress of parenting, a desired response would be "Almost Never" which would be coded as a 4. This dataset contains 14 likert variables.

% \subsubsection*{Binary Variables}
% Binary variables are coded as 1 if the response matches target value and 0 if not. A higher mean would indicate a higher percentage of respondents marked the desired response. In this dataset, we have 33 binary variables.

% \subsubsection*{Constructs}

% We now summarize the constructs measured by the vari  ables. The constructs are calculated as the mean of the variables under them.
...
% \input{descriptives/tables/Bebbo Usage in Control Group}
...
% \input{regressions/Pooled: OLS - Follow Up - Knowledge and Awareness.tex}
% \input{regressions/Pooled: OLS - Follow Up - Confidence and Attitudes.tex}
% \input{regressions/Pooled: OLS - Follow Up - Practices.tex}

% \input{regressions/Pooled: 2SLS - Follow Up - Knowledge and Awareness.tex}
% \input{regressions/Pooled: 2SLS - Follow Up - Confidence and Attitudes.tex}
% \input{regressions/Pooled: 2SLS - Follow Up - Practices.tex}
...
% \input{baseline imbalance/tables/country_baseline_constructs_imbalance}
...
% \input{baseline imbalance/tables/treatment_baseline_imbalance_serbia}
% \input{baseline imbalance/tables/treatment_baseline_imbalance_bulgaria}
